...
<p align="center"><img src="../output/imagegen/simplicio-loop-oss-hero.png" alt="Loop contínuo de contribuição open source ao redor de um repositório" width="100%"></p>

<p align="center"><strong>Um loop persistente e orientado por qualidade para contribuir com repositórios open source.</strong><br>Reconhecimento vira contexto. Contexto vira pull request pequeno e testado. Cada iteração deixa o workspace pronto para continuar.</p>
...
<p align="center"><img src="../output/imagegen/simplicio-loop-oss-mission-control.png" alt="Loop contínuo de contribuição open source ao redor de um repositório" width="100%"></p>

## Por que este projeto existe

Reconhecimento vira contexto. Contexto vira pull request pequeno e testado. Cada iteração deixa o workspace pronto para continuar.
...
Requisitos: git, Python 3.10+, gh autenticado e um host de LLM capaz de executar comandos.

~~~text
Run the simplicio-loop-oss skill for one iteration against owner/repo
~~~

Leia o guia completo no README em inglês.

## Persistent state

projects/<owner>__<repo>/ guarda PROFILE.md, logs, backlogs, auditorias e opened-prs.md. O estado versionado é o handoff entre máquinas e agentes.
