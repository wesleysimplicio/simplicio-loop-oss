...
<p align="center"><img src="../output/imagegen/simplicio-loop-oss-hero.png" alt="Loop kontribusi open source berkelanjutan di sekitar repositori" width="100%"></p>

<p align="center"><strong>Loop kontribusi persisten dengan gerbang kualitas untuk repositori open source.</strong><br>Pengintaian menjadi konteks. Konteks menjadi pull request kecil yang teruji. Setiap iterasi membuat pekerjaan mudah dilanjutkan.</p>
...
<p align="center"><img src="../output/imagegen/simplicio-loop-oss-mission-control.png" alt="Loop kontribusi open source berkelanjutan di sekitar repositori" width="100%"></p>

## Mengapa proyek ini ada

Pengintaian menjadi konteks. Konteks menjadi pull request kecil yang teruji. Setiap iterasi membuat pekerjaan mudah dilanjutkan.
...
Persyaratan: git, Python 3.10+, gh yang sudah diautentikasi, dan host LLM yang dapat menjalankan perintah shell.

~~~text
Run the simplicio-loop-oss skill for one iteration against owner/repo
~~~

Baca panduan lengkap di README bahasa Inggris.

## Persistent state

projects/<owner>__<repo>/ menyimpan PROFILE.md, log, backlog, audit, dan opened-prs.md. State berversi menjadi handoff antar mesin dan agen.
