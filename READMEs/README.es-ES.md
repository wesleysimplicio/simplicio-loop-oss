...
<p align="center"><img src="../output/imagegen/simplicio-loop-oss-hero.png" alt="Bucle continuo de contribución open source alrededor de un repositorio" width="100%"></p>

<p align="center"><strong>Un bucle persistente y guiado por calidad para contribuir a repositorios open source.</strong><br>El reconocimiento se convierte en contexto. El contexto se convierte en un pull request pequeño y probado. Cada iteración deja el workspace listo para continuar.</p>
...
<p align="center"><img src="../output/imagegen/simplicio-loop-oss-mission-control.png" alt="Bucle continuo de contribución open source alrededor de un repositorio" width="100%"></p>

## Por qué existe

El reconocimiento se convierte en contexto. El contexto se convierte en un pull request pequeño y probado. Cada iteración deja el workspace listo para continuar.
...
Requisitos: git, Python 3.10+, gh autenticado y un host LLM capaz de ejecutar comandos.

~~~text
Run the simplicio-loop-oss skill for one iteration against owner/repo
~~~

Lee la guía completa en el README en inglés.

## Persistent state

projects/<owner>__<repo>/ guarda PROFILE.md, logs, backlogs, auditorías y opened-prs.md. El estado versionado permite continuar entre máquinas y agentes.
