...
<p align="center"><img src="../output/imagegen/simplicio-loop-oss-hero.png" alt="Ciągła pętla wkładu open source wokół repozytorium" width="100%"></p>

<p align="center"><strong>Trwała pętla wkładu z kontrolą jakości dla repozytoriów open source.</strong><br>Rozpoznanie staje się kontekstem, a kontekst małym, przetestowanym pull requestem. Każda iteracja ułatwia wznowienie pracy.</p>
...
<p align="center"><img src="../output/imagegen/simplicio-loop-oss-mission-control.png" alt="Ciągła pętla wkładu open source wokół repozytorium" width="100%"></p>

## Dlaczego to istnieje

Rozpoznanie staje się kontekstem, a kontekst małym, przetestowanym pull requestem. Każda iteracja ułatwia wznowienie pracy.
...
Potrzebujesz git, Pythona 3.10+, uwierzytelnionego gh i hosta LLM wykonującego polecenia.

~~~text
Run the simplicio-loop-oss skill for one iteration against owner/repo
~~~

Pełny przewodnik znajdziesz w angielskim README.

## Persistent state

projects/<owner>__<repo>/ przechowuje PROFILE.md, logi, backlog, audyty i opened-prs.md. Wersjonowany stan przekazuje pracę między maszynami i agentami.
