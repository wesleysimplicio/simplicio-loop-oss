...
<p align="center"><img src="../output/imagegen/simplicio-loop-oss-hero.png" alt="Непрерывный цикл open source вклада вокруг репозитория" width="100%"></p>

<p align="center"><strong>Постоянный цикл вклада в open source с контролем качества.</strong><br>Разведка становится контекстом, контекст — небольшой проверенной pull request. Каждая итерация упрощает продолжение работы.</p>
...
<p align="center"><img src="../output/imagegen/simplicio-loop-oss-mission-control.png" alt="Непрерывный цикл open source вклада вокруг репозитория" width="100%"></p>

## Зачем это нужно

Разведка становится контекстом, контекст — небольшой проверенной pull request. Каждая итерация упрощает продолжение работы.
...
Нужны git, Python 3.10+, авторизованный gh и LLM-хост, умеющий выполнять команды.

~~~text
Run the simplicio-loop-oss skill for one iteration against owner/repo
~~~

Полное руководство находится в английском README.

## Persistent state

projects/<owner>__<repo>/ хранит PROFILE.md, логи, backlog, аудиты и opened-prs.md. Версия состояния служит handoff между машинами и агентами.
